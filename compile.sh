...
g++ -o tests -pthread -I/usr/local/cuda/include -L/usr/local/cuda/lib64 tests.cpp matrix.cpp GSW.cpp csprng.o GPU-wrapper.o kernel.o  uint256_t.o uint128_t.o -lntl -lgmp -lm -lcuda -lcudart 
